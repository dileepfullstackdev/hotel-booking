        ...
        <PublicRoute>
            <div className="relative min-h-screen w-full overflow-hidden flex flex-col justify-center items-center px-6 bg-black z-0">
                ...
                <motion.div 
                    ...
                    className="relative z-10 w-full max-w-md mt-10 md:mt-0"
                >
                    {/* Header */}
                    ...
                    <div className="bg-white/10 backdrop-blur-2xl p-6 sm:p-8 rounded-3xl border border-white/20 shadow-2xl">
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="flex flex-col w-full gap-2">
                                <label className="text-white/90 font-semibold uppercase tracking-wider text-[11px] ml-1" htmlFor="name">
                                    Name
                                </label>
                                ...
                                {errors.name && (
                                    <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} className="text-red-300 text-xs font-semibold ml-1 flex items-center gap-1.5">
                                        <span className="w-1.5 h-1.5 rounded-full bg-red-400"></span> {errors.name.message}
                                    </motion.p>
                                )}
                            </div>
                            ...
                            <div className="flex flex-col w-full gap-2">
                                ...
                                {errors.password && (
                                    <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} className="text-red-300 text-xs font-semibold ml-1 flex items-center gap-1.5">
                                        <span className="w-1.5 h-1.5 rounded-full bg-red-400"></span> {errors.password.message}
                                    </motion.p>
                                )}
                            </div>

                            <div className="flex flex-col w-full gap-2">
                                <label className="text-white/90 font-semibold uppercase tracking-wider text-[11px] ml-1" htmlFor="confirmPassword">
                                    Confirm Password
                                </label>
                                <div className="relative w-full">
                                    <div className="absolute left-4 top-1/2 -translate-y-1/2 z-10 pointer-events-none">
                                ...
                                {errors.confirmPassword && (
                                    <motion.p initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} className="text-red-300 text-xs font-semibold ml-1 flex items-center gap-1.5">
                                        <span className="w-1.5 h-1.5 rounded-full bg-red-400"></span> {errors.confirmPassword.message}
                                    </motion.p>
                                )}
                            </div>
